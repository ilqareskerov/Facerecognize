...
from ai_detectfaces_mtcnn.Configurations import get_logger
from ai_training.softmax import SoftMax
...
class TrainFaceRecogModel:
    ...
    def trainKerasModelForFaceRecognition(self):
        ...
        for train_idx, valid_idx in cv.split(embeddings):
            ...
            print(his.history[acc_key])

            history['acc'] += his.history[acc_key]
            history['val_acc'] += his.history[val_acc_key]
            history['loss'] += his.history['loss']
            history['val_loss'] += his.history['val_loss']

            self.logger.info(his.history[acc_key])
