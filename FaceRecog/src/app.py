...
from src.ai_collect_trainingdata.get_faces_from_camera import TrainingDataCollector
from src.ai_face_embedding.faces_embedding import GenerateFaceEmbedding
from src.ai_predictor.facePredictor import FacePredictor
from src.ai_training.train_softmax import TrainFaceRecogModel
...
class RegistrationModule:
    def __init__(self, logFileName):
        ...
        header = tk.Label(self.window, text="Monitoring Registration", width=80, height=2, fg="white", bg="#363e75",
        ...
        empName = tk.Label(self.window, text="Name", width=10, fg="white", bg="#363e75", height=1, font=('times', 15))
        ...
        # emailId = tk.Label(self.window, text="Email ID :", width=10, fg="white", bg="#363e75", height=1, font=('times', 15))
        ...
        mobileNo = tk.Label(self.window, text="Mobile No :", width=10, fg="white", bg="#363e75", height=1,
                            font=('times', 15))
